...
import PyPDF2
from tkinter import Tk, Toplevel, filedialog, Button, Label, Entry, StringVar, END, messagebox, Canvas
...
class PDFSplitter:
    def __init__(self, master):
        ...
        # These widgets appear only after file is selected
    ...
    def show_preview_window(self):
        ...
        # Bind arrow keys to preview window
        ...
        # Set focus to preview window so key events work immediately
    ...
    def save_selected_pages(self):
        try:
            ...
            output_filename = f"{output_base_name}.pdf"  # Only user-given name + .pdf
